...
public static class BtConstants
{
    ...
    public static readonly Dictionary<string, HydrationProperties> HydratingLiquids = new()
    {
        ...
        { "@(.*):.*ciderportion.*", new HydrationProperties { Hydration = 120 } },
        { "@(.*):.*spiritportion.*", new HydrationProperties { Hydration = 30 } },
        ...
        { "@(.*):strongspiritportion.*", new HydrationProperties { Hydration = 20 } },
        { "@(.*):potentspiritportion.*", new HydrationProperties { Hydration = -10 } },
        { "@(.*):vegetablejuiceportion.*", new HydrationProperties { Hydration = 160 } },
        { "@(.*):potentwineportion.*", new HydrationProperties { Hydration = 60 } },
        ...
        { "@(game):saltwaterportion", new HydrationProperties { Hydration = 120, Purity = EnumPurityLevel.Okay, EuhydrationWeight = -0.5f } },
        { "@(game):brineportion", new HydrationProperties { Hydration = 160, Purity = EnumPurityLevel.Pure, EuhydrationWeight = 0 } },
        { "@(game):rot", new HydrationProperties { Hydration = 40, Purity = EnumPurityLevel.Yuck, EuhydrationWeight = -0.7f } },
        { "@(game):honeycomb", new HydrationProperties { Hydration = 20 } },
        ...
        { "@(expandedfoods):dryfruit-.*", new HydrationProperties { Hydration = 10 } },
        ...
        { "@(expandedfoods):peanutliquid-butter", new HydrationProperties { Hydration = 0 } },
        { "@(expandedfoods):maplesapportion-*", new HydrationProperties { Hydration = 80 } },
